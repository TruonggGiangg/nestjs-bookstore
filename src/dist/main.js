...
var permissions_service_1 = require("./permissions/permissions.service");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, permissionService, reflector;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    permissionService = app.get(permissions_service_1.PermissionsService);
                    //dùng file public và định dạng view
                    app.useStaticAssets(path_1.join(__dirname, '..', 'public'));
                    app.setBaseViewsDir(path_1.join(__dirname, '..', 'views'));
                    app.setViewEngine('ejs');
                    app.useGlobalPipes(new common_1.ValidationPipe()); //validate data
                    //set use cookie
