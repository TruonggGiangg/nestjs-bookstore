...
var BooksController = /** @class */ (function () {
    ...
    BooksController.prototype.create = function (createBookDto, iUser) {
        return this.booksService.create(createBookDto, iUser);
    };
    BooksController.prototype.findAll = function (currentPage, limit, qs) {
        return this.booksService.findAll(+currentPage, +limit, qs);
    };
    BooksController.prototype.searchBooks = function (keyword, currentPage, limit) {
        if (currentPage === void 0) { currentPage = '1'; }
        if (limit === void 0) { limit = '10'; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.booksService.searchBooks(keyword, +currentPage, +limit)];
            });
        });
    };
    ...
    BooksController.prototype.update = function (id, updateBookDto, iUser) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.booksService.update(id, updateBookDto, iUser)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    BooksController.prototype.remove = function (id, iUser) {
        return this.booksService.remove(id, iUser);
    };
    __decorate([
        common_1.Post(),
        customize_1.ResponseMessage("Tạo sách"),
